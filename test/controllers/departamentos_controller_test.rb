...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { activo: @departamento.activo, nombre: @departamento.nombre, provincia_id: @departamento.provincia_id } }, as: :json
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { activo: @departamento.activo, nombre: @departamento.nombre, provincia_id: @departamento.provincia_id } }, as: :json
    assert_response 200
  end
